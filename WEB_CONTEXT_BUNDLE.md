...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-db20499b4dd29c70"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-db20499b4dd29c70",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-db20499b4dd29c70",
        "url": "https://en.wikipedia.org/wiki/Overfull_graph#Overfull_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The overfull conjecture that a graph with maximum degree $\\Delta (G)\\geq n/3$ is class 2 if and only if it has an overfull subgraph $S$ satisfying $\\Delta (S)=\\Delta (G)$ .",
      "version": 1
    },
    "title": "overfull conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "3373a88809564adb2249b991a8e2a8d008d91147c15aad08bf01feeb385b1c2d"
}
```
